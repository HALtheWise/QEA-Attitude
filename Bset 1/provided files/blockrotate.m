...
function [M]=animate(psin, thetan,phin)
...
% first rotation, R1, is psi about z-axis (3-yaw)
% R1 = [    ];
% second rotation, R2, is theta about y'-axis, (2-pitch)
% R2 = [   ];
% third rotation, R3, is phi about x''-axis, (1-roll) 
% R3= [   ];
